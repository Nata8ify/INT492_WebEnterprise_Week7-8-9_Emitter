...
public class SignupController {
	...
	public Object add(@ModelAttribute("userAddForm") @Valid UserAddForm userAddForm
			, BindingResult bindingResultResult
		...
		redirectAttrs.addFlashAttribute("messageDialog", "User was created.");
